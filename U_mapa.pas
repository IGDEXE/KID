...
uses U_Mapa2, U_gameover, U_black, U_cred2;
...
procedure TForm1.tmbt1Timer(Sender: TObject);
begin
...
procedure TForm1.tmbt2Timer(Sender: TObject);
begin
...
begin
  mpgame.Play();
  //Ponto inicial dos booths e do player 1
  imgp1.top := 432;
  imgp1.left := 808;
//------------------------------------------------------------------------------
  gf2 := 1488;
...
procedure TForm1.tmbt3Timer(Sender: TObject);
begin
...
procedure TForm1.tmbt4Timer(Sender: TObject);
begin
...
procedure TForm1.tmareaTimer(Sender: TObject);
begin
  //Area onde fica os portais
//------------------------------------------------------------------------------
  if (imgp1.Top > 455 ) and (imgp1.top < 609) and (imgp1.Left >= 0 ) and (imgp1.left < 201) then
  begin
